...
<!--        <div className="p-6 sm:px-20 bg-white border-b border-gray-200">
        ...
        <div style="margin: 0 auto" class=" grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
            ...
            <!--            <div class="flex justify-center">
                            <div class="flex">
                                <h1 class="text-gray-600 font-bold md:text-2xl text-xl">扫描型号</h1>
                            </div>
                        </div>-->

            <div class="grid grid-cols-1 mt-5 mx-7">
                <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">型号条码</label>
                <input autofocus class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" placeholder="型号条码" />
            </div>
            ...
            <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
                <button class='w-auto bg-gray-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>取消</button>
                <a href="/scan/samsung/form" class='w-auto bg-purple-500 hover:bg-purple-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>确定</a>
            </div>
